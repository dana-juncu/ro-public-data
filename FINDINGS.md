...
- Confirmed live: `limit_rows=0` returns all **2,796 rows** — real addresses, sector, construction year, named certified structural engineers, and seismic risk classification (RsI/RsII/RsIII). No key, no login, no rate limit observed.
